...
export async function getServerSideProps() {
	try {
		const res = await fetch(
			'https://api.worldbank.org/v2/country/ind;chn;usa;br/indicator/NY.GDP.MKTP.KD.ZG?date=2013:2023&format=json'
		);
...
export default function Home({gdpData, error}) {
	...
	return (
		<div className='container-fluid'>
			<h1 className='display-6 text-center m-2'>World Bank GDP Growth Data (2013 - 2023)</h1>
